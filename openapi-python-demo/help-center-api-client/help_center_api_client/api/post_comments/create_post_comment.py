...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = PostCommentResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    * End users
    ...
    comments at a time. Specify the property in the root of the JSON object, not in the \"comment\"
    object.
