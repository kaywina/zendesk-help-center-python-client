...
from ...models.topics_response import TopicsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/help_center/user_segments/{user_segment_id}/topics",
    }
...
) -> Optional[TopicsResponse]:
    if response.status_code == 200:
        response_200 = TopicsResponse.from_dict(response.json())
